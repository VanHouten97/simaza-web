(function () {
  ...
  angular.module('SIMAZE.pages.virtualizacao')
      .controller('agentesMapCtrl', agentesMapCtrl);

  /** @ngInject */
  function agentesMapCtrl($timeout) {
      var markers = [];
      function initialize() {
        var mapOptions = {
          zoom: 13,
          center: new google.maps.LatLng(-19.242099, -44.20248684),
        ...
        var latlngbounds = new google.maps.LatLngBounds();
          ...
          var pontos = {
                          1:{ nome: "João Pereira da Silva", Id: 1, Latitude: -19.205741, Longitude: -44.250801,  casas: 13 },
                          2:{ nome: "Luís Americo Abreu",    Id: 2, Latitude: -19.201331, Longitude: -44.249133,   casas: 24 },
                          3:{ nome: "Reinaldo Gomes Azevedo",  Id: 3, Latitude: -19.202354, Longitude: -44.243754, casas: 5 }
                      }
          var image = {
              url: 'https://developers.google.com/maps/documentation/javascript/examples/full/images/beachflag.png'
          };

          $.each(pontos, function(i, val) {
				...
				if(i == 1){
					var agente = "assets/pictures/joao.jpg";
				}
				if(i == 2){
					var agente = "assets/pictures/luiz.jpg";
				}
				if(i == 3){
					var agente = "assets/pictures/reinaldo.jpg";
				}

			var contentString = '<div id="content">'+
				'<div id="siteNotice">'+
				'</div>'+
				'<h1 id="firstHeading" class="firstHeading">' + '<img src="' + agente + '" height="100px" width="100px" alt="foto"style="padding-right:20px">' + val.nome + '</h1>' +
				'<div><br /></div><div id="bodyContent">'+
				'<p>Localização:<strong> ' + val.Latitude + ',' + val.Longitude + '</strong>.</p>' + '<p>Residência inspecionadas (Hoje): <strong>' + val.casas + '</strong>.</p>' +
				'</div>';
