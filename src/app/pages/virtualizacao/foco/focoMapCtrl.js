(function () {
  ...
  angular.module('SIMAZE.pages.virtualizacao')
      .controller('focoMapCtrl', focoMapCtrl);

  /** @ngInject */
  function focoMapCtrl($timeout) {
      var markers = [];
    function initialize() {
      var mapOptions = {
    	zoom: 15,
    	center: new google.maps.LatLng(-19.202712, -44.248302),
    	mapTypeId: google.maps.MapTypeId.ROADMAP
      };


      var map = new google.maps.Map(document.getElementById('google-maps-foco'), mapOptions);
      ...
      var latlngbounds = new google.maps.LatLngBounds();
    	...
    	var pontos = {
    					1:{ mag: 4,  Id: 1, Latitude: -19.205741, Longitude: -44.250801},
    					2:{ mag: 7,  Id: 2, Latitude: -19.201331, Longitude: -44.249133},
    					3:{ mag: 5,  Id: 3, Latitude: -19.202354, Longitude: -44.243754},
    					4:{ mag: 5,  Id: 4, Latitude: -19.203674, Longitude: -44.246172},
    					5:{ mag: 7,  Id: 5, Latitude: -19.206969, Longitude: -44.248478},
    					6:{ mag: 3,  Id: 6, Latitude: -19.205536, Longitude: -44.253060},
    					7:{ mag: 5,  Id: 7, Latitude: -19.208832, Longitude: -44.254062},
    					8:{ mag: 5,  Id: 8, Latitude: -19.197140, Longitude: -44.248144},
    					9:{ mag: 7,  Id: 9, Latitude: -19.196538, Longitude: -44.251118},
    					10:{ mag: 7,  Id: 10, Latitude: -19.209262, Longitude: -44.248205}
    				}
    	...
    	jQuery.each(pontos, function(i, val) {
    		...
    		var marker = new google.maps.Marker({
    			...
    			title: "Focos de dengue - Araçai - Minas Gerais",
    			icon: icone
    		});
    		markers.push(marker);
