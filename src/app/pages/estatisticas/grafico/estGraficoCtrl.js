(function() {
    ...
    angular.module('SIMAZE.pages.estatisticas')
        .controller('estGraficoCtrl', estGraficoCtrl);

    /** @ngInject */
    function estGraficoCtrl(baConfig, layoutPaths) {
        ...
        var chart = AmCharts.makeChart(id, {
          ...
          "graphs": [{
            ...
            "lineAlpha": 0.8,
            "type": "column",
            "title": "Residencias Inspecionadas",
            "valueField": "sales2",
            "clustered": false,
            "columnWidth": 0.5,
            "lineColorField" : layoutColors.defaultText,
            "legendValueText": "[[value]]K",
            "balloonText": "[[title]]<br/><b style='font-size: 130%'>[[value]]K</b>"
          }, {
            "id": "g4",
            "valueAxis": "v1",
            color: layoutColors.defaultText,
